...
# annual health utility of each health state - assumptions were made based on the Hmwk assignments in class about stroke utility rates - we assumed all cardiac events had the same utility
ANNUAL_STATE_UTILITY = [
    1.0,   # Healthy with HIV
    0.9,   # HIV+ and experienced cardiac event
    0.0    # Death from cardiac event
    ]

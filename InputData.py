...
# simulation settings
POP_SIZE = 4287     # The cohort population size is the total number of people >50yrs of age living with HIV in USA - source: https://www.cdc.gov/hiv/group/age/olderamericans/index.html
